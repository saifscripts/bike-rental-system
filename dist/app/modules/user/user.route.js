...
router
    .route('/avatar')
    .post((0, auth_1.default)(user_constant_1.USER_ROLE.ADMIN, user_constant_1.USER_ROLE.USER), upload.single('avatar'), user_controller_1.UserControllers.updateAvatar);
router
    .route('/contact-us')
