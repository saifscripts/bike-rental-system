...
router
    .route('/')
    .post((0, auth_1.default)(user_constant_1.USER_ROLE.ADMIN), upload_1.upload.single('image'), bodyParser_1.bodyParser, (0, validateRequest_1.default)(bike_validation_1.BikeValidations.createBikeValidationSchema), bike_controller_1.BikeControllers.createBike)
